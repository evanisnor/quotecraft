...
| ✅     | INFR-US4-A006 | Implement Google OAuth with PKCE                                                                                              | 1   | 2026-03-08 |
| ✅     | INFR-US4-A007 | Add rate limiting on auth endpoints                                                                                           | 1   | 2026-03-08 |
...
| ✅     | INFR-US5-A006 | Implement duplicate calculator endpoint                            | 1   | 2026-03-08 |
| ✅     | INFR-US5-A007 | Implement public config endpoint with cache headers                | 0   | 2026-02-23 |
| ✅     | INFR-US5-A008 | Add rate limiting on public config endpoint                        | 1   | 2026-03-08 |
...
| ✅     | INFR-US6-A006 | Implement image upload endpoint with type/size validation using the `Storage` interface                 | 1   | 2026-03-08 |
...
| ✅     | BLDR-US2-A009 | Implement Image Select field type with image upload                                    | 2   | 2026-03-09 |
...
| ✅     | BLDR-US4-A003 | Wire shared formula engine into the preview                                     | 0   | 2026-03-02 |
| ✅     | BLDR-US4-A004 | Implement real-time reactivity: config changes propagate to preview immediately | 0   | 2026-03-02 |
...
| ✅     | CALC-US1-A006 | Add MIN, MAX, ABS, ROUND function support                             | 1   | 2026-03-15 |
| ✅     | CALC-US1-A007 | Implement execution timeout (100ms abort)                             | 1   | 2026-03-15 |
| ✅     | CALC-US1-A008 | Implement error messages with "did you mean?" suggestions             | 1   | 2026-03-15 |
